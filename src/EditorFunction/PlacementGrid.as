...
namespace EditorHelpers
{
    ...
    class PlacementGrid : EditorHelpers::EditorFunction
    {
        ...
        void RenderInterface_Settings() override
        {
            ...
            UI::TextWrapped("Enables forcing on the editor's placement grid, also know as 'helpers'. Normally you would need to turn this on each time you enter the editor but with this function the plugin can do that for your. Additionally, there is an option to make the grid a transparent wireframe which can be quite helpful for building in free block mode and off grid.");
